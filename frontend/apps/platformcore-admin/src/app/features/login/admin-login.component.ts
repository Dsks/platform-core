...
import { CurrentUser, PLATFORMCORE_ROLES } from '@platformcore/shared-models';
...
export class AdminLoginComponent {
  ...
  private isAdminUser(user: CurrentUser): boolean {
    return (
      user.roles.includes(PLATFORMCORE_ROLES.ADMIN) ||
      user.roles.includes(PLATFORMCORE_ROLES.SUPERADMIN)
    );
  }
}
