...
import { SessionStore, sha256Hex } from '@platformcore/shared-auth';
import type { CurrentUser, UserDetail } from '@platformcore/shared-models';
...
describe('UserFormComponent', () => {
  ...
  it('updates only the active flag in edit mode', async () => {
    ...
    fixture.detectChanges();
    fixture.componentInstance.form.patchValue({
      email: 'changed@platformcore.test',
