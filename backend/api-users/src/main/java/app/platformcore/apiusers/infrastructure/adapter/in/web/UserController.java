...
import app.platformcore.apiusers.infrastructure.adapter.in.web.dto.CreateUserRequest;
import app.platformcore.apiusers.infrastructure.adapter.in.web.dto.RegistrationAcceptedResponse;
import app.platformcore.apiusers.infrastructure.adapter.in.web.dto.UserResponse;
...
@SecurityRequirement(name = "platformcoreAuthCookie")
  ...
  @Operation(
      ...
      description =
          "Creates a user account from an authenticated administrative context. The endpoint"
              + " requires the PLATFORMCORE_AUTH cookie, a valid CSRF token header, and an ADMIN or"
