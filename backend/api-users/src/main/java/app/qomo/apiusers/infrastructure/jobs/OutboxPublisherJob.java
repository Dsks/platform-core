...
public class OutboxPublisherJob {
   ...
   *
   * <p>Spring schedules this method with the {@code qomo.outbox.publisher.fixed-delay-ms} property,
   * using the same value for the initial delay and the delay after each completed execution. The
   * method is public and side-effect driven, so tests or E2E support code can invoke it directly to
   * drain the outbox without waiting for the scheduler.
   *
