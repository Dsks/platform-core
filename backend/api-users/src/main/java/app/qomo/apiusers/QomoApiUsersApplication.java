 ...
 *
 * <p>This service owns the user-facing identity and account lifecycle concerns within Qomo
 * Platform. Runtime wiring is delegated to the module's configuration, adapters, and application
 * services, so this class should remain minimal and free of business logic.
 */
