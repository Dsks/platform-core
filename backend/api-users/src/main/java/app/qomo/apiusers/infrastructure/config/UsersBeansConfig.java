...
public class UsersBeansConfig {
   ...
   *
   * @param secret sensitive signing secret from {@code qomo.security.jwt.secret}
   * @param expirationMs token lifetime from {@code qomo.security.jwt.expiration-ms}; defaults to
   *     one day when the property is absent
   */
  @Bean
   ...
   *
   * <p>The worker is enabled by {@code qomo.outbox.publisher.enabled}, which defaults to enabled.
   * Batch size, maximum attempts, and minimum message age are runtime-tunable properties so retry
   * pressure can be changed without altering the job implementation.
   *
   ...
   * @param batchSize value of {@code qomo.outbox.publisher.batch-size}; defaults to {@code 50}
   * @param maxAttempts value of {@code qomo.outbox.publisher.max-attempts}; defaults to {@code 10}
   * @param minAgeMs value of {@code qomo.outbox.publisher.min-age-ms}; defaults to {@code 500}
   */
  @Bean
   ...
   * @param emailOtpTtlSeconds value of {@code qomo.security.verification.otp.ttl-seconds}; defaults
   *     to {@code 600}
   * @param resendMinIntervalSeconds value of {@code
   *     qomo.security.verification.resend-min-interval-seconds}; defaults to {@code 60}
   * @param emailCommandsTopic Kafka topic from {@code qomo.kafka.topics.email-commands}; defaults
   *     to {@code qomo.email.commands}
   */
  @Bean
   ...
   * @param maxAttempts value of {@code qomo.security.verification.otp.max-attempts}; defaults to
   *     {@code 5}
   */
  @Bean
   ...
   *
   * <p>{@code qomo.bootstrap.superadmin.initial-password} is sensitive bootstrap material and may
   * be blank to disable creation. {@code qomo.bootstrap.superadmin.email} identifies the account
   * and defaults to {@code superadmin@qomo.app}.
   *
   ...
   *     qomo.bootstrap.superadmin.initial-password}
   * @param superAdminEmail value of {@code qomo.bootstrap.superadmin.email}; defaults to {@code
   *     superadmin@qomo.app}
   */
  @Bean
