...
public interface CreateUserUseCase {
   ...
   *     data is missing
   * @throws app.qomo.apiusers.application.exception.EmailAlreadyInUseException when this flow is
   *     allowed to expose that the email is already registered
   * @throws app.qomo.apiusers.application.exception.ForbiddenOperationException when the current
   *     actor is not allowed to assign the requested roles
   * @throws app.qomo.apiusers.application.exception.RoleNotFoundException when an allowed requested
   *     role cannot be resolved by the application
   */
