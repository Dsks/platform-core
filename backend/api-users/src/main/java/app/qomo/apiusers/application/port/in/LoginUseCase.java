...
public interface LoginUseCase {
   ...
   *     data is missing
   * @throws app.qomo.apiusers.application.exception.InvalidCredentialsException when credentials
   *     are invalid without disclosing which value failed
   * @throws app.qomo.apiusers.application.exception.UserInactiveException when the account exists
   *     but is not active
   */
