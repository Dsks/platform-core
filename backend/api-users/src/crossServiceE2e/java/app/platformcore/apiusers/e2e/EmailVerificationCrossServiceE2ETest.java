package app.platformcore.apiusers.e2e;

import static org.assertj.core.api.Assertions.assertThat;

import app.platformcore.apiusers.PlatformCoreApiUsersApplication;
...
class EmailVerificationCrossServiceE2ETest {
  ...
  private static final String TOPIC_EMAIL_COMMANDS = "platformcore.email.commands.e2e";
  ...
  void shouldProcessEmailVerificationAcrossApiUsersAndEmailSender() throws Exception {
    Class<?> emailSenderApplicationClass =
        Class.forName("app.platformcore.emailsender.PlatformCoreEmailSenderApplication");
    ...
    emailSenderContext =
        new SpringApplicationBuilder(emailSenderApplicationClass)
            ...
            .run(
                ...
                "--platformcore.kafka.topics.email-commands=" + TOPIC_EMAIL_COMMANDS,
                "--platformcore.email.payload-key-b64=MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY=",
    ...
    usersContext =
        new SpringApplicationBuilder(PlatformCoreApiUsersApplication.class)
            .run(
                ...
                "--spring.kafka.bootstrap-servers=" + kafkaBootstrapServers(),
                "--platformcore.kafka.topics.email-commands=" + TOPIC_EMAIL_COMMANDS,
                "--platformcore.security.jwt.secret=jwt-secret-for-e2e-only",
                "--spring.task.scheduling.enabled=false",
                "--server.port=0");
    ...
    registerUserUseCase.register(
        new RegisterUserUseCase.Command("cross-service-e2e@platformcore.app", "StrongPassw0rd!"));
