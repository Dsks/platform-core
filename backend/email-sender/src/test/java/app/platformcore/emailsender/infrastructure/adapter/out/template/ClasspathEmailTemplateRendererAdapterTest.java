package app.platformcore.emailsender.infrastructure.adapter.out.template;
...
import app.platformcore.emailsender.application.exception.TemplateNotFoundException;
...
class ClasspathEmailTemplateRendererAdapterTest {
  ...
  void render_supportedTemplate_replacesPlaceholdersFromModel() {
    ...
    String rendered =
        adapter.render(
            "EMAIL_VERIFICATION", Map.of("verificationCode", "123456", "appName", "PlatformCore"));

    assertNotEquals(-1, rendered.indexOf("<strong>123456</strong>"));
    assertNotEquals(-1, rendered.indexOf("PlatformCore - Email Verification"));
